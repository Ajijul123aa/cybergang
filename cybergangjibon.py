...
╚═╝░░╚═╝░╚════╝░╚═╝░╚════╝░░╚═════╝░╚══════╝
 ...
 ♨️°───────(💝-JIBON_VAI)───────°♨️ 
\033[1;92m║══▒═✺═▒═✺═▒═══¤═¤═¤════════════¤═══║
\033[1;96m║✯ Creator ✯ AJIJUL HASAN(JIBON)      ║    
\033[1;98m║✯ SPAMMING TEAM-CYBER GANG            ║  
...
print  """
\033[1;97m************************************************
\033[1;96m~ IM NOT RESPONSIBLE FOR ANY MISS USE MR JIBON ~
\033[1;97m************************************************
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:JIBON_VI
	    time.sleep(2)
            loop = 'false'
        else:
        ...
        os.system('xdg-open https://www.facebook.com/AjijulHasanJibonOfficiall123/')
...
def menu():
	...
	print "\033[1;36;40m      ╚═════════════════════════════════╝"
	print "    \033[1;32;40m[Type1] \033[1;33;40m‹•.•›Start Hacking With Jibon"	
	print "    \033[1;32;40m[type2] \033[1;33;40m‹•.•›Update Jibon's Tool"																														
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;91mAJIJUL-HASAN\033[1;97m═══•◈•"
	...
	jalan('          \033[1;91mJIBON-VAI cloning Wait...')
	print  "  \033[1;92m ◄══════════════════PONIR-JIBON══════════════════►" 
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬•◈\033[1;91mAJIJUL(JIBON)\033[1;95m◈•▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed Jibon+Ponir--•◈•---»" #Dev:Asim-Ch
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 cybergangjibon.py)↩\033[1;97m....'
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ..JIBON VAI Creations.. \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Instagram
              \033[1;91majijil-hasan"""
